<?php
namespace Zangyd\Util\ZangydHttp\Http2;
...
class SwooleClient implements IHttp2Client
{
     ...
     * Swoole 协程客户端对象
     *
     * @var \Zangyd\Util\ZangydHttp\Handler\Swoole $handler
     */
    private $handler;
     ...
     * @param int $port
     * @param bool $ssl
     * @param \Zangyd\Util\ZangydHttp\Handler\Swoole $handler
     */
    public function __construct($host, $port, $ssl, $handler = null)
    {
        ...
        {
            $this->handler = new \Zangyd\Util\ZangydHttp\Handler\Swoole;
        }
    }
     ...
     * @return \Zangyd\Util\ZangydHttp\Http\Response|bool
     */
