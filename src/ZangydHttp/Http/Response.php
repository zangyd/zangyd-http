<?php
namespace Zangyd\Util\ZangydHttp\Http;

use Zangyd\Util\ZangydHttp\Http\Psr7\Consts\StatusCode;
use Zangyd\Util\ZangydHttp\Http\Psr7\Response as Psr7Response;
...
class Response extends Psr7Response
{
     ...
     * 设置请求体
     *
     * @param \Zangyd\Util\ZangydHttp\Http\Request
     *  $request
     * @return static
     */
