<?php
namespace Zangyd\Util\ZangydHttp\Http\Psr7;
...
use Zangyd\Util\ZangydHttp\Http\Psr7\Consts\RequestHeader;
use Zangyd\Util\ZangydHttp\Http\Psr7\Consts\RequestMethod;
...
class ServerRequest extends Request implements ServerRequestInterface
{
    ...
    /**
     * 上传的文件
     * @var \Zangyd\Util\ZangydHttp\Http\Psr7\UploadedFile[]
     */
    protected $files = [];
    ...
    public function getAttribute($name, $default = null)
    {
        ...
        {
            return ZangydHttp::getAttribute($name, $default);
        }
    }
     ...
     * 设置上传的文件
     * @param self $object
     * @param \Zangyd\Util\ZangydHttp\Http\Psr7\UploadedFile[] $files
     * @return static
     */
