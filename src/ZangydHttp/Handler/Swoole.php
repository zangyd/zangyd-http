...
use Zangyd\Util\ZangydHttp\Attributes;
use Zangyd\Util\ZangydHttp\Http\Psr7\Uri;
use Zangyd\Util\ZangydHttp\Http\Response;
use Swoole\Http2\Request as Http2Request;
use Zangyd\Util\ZangydHttp\Traits\THandler;
use Zangyd\Util\ZangydHttp\Traits\TCookieManager;
use Zangyd\Util\ZangydHttp\Http\Psr7\Consts\MediaType;
use Zangyd\Util\ZangydHttp\Exception\WebSocketException;
use Zangyd\Util\ZangydHttp\Handler\Swoole\HttpConnectionManager;
use Zangyd\Util\ZangydHttp\Handler\Swoole\Http2ConnectionManager;
...
class Swoole implements IHandler
{
     ...
     * Http 连接管理器
     *
     * @var \Zangyd\Util\ZangydHttp\Handler\Swoole\HttpConnectionManager
     */
     ...
     * Http2 连接管理器
     *
     * @var \Zangyd\Util\ZangydHttp\Handler\Swoole\Http2ConnectionManager
     */
    ...
    public function __construct()
    {
        ...
        {
            static::$defaultUA = sprintf('Mozilla/5.0 ZangydHttp/%s Swoole/%s', ZangydHttp::VERSION, defined('SWOOLE_VERSION') ? SWOOLE_VERSION : 'unknown');
        }
    ...
    public function websocket($request, $websocketClient = null)
    {
        if(!$websocketClient)
        {
            $websocketClient = new \Zangyd\Util\ZangydHttp\WebSocket\Swoole;
        }
     ...
     * Get http 连接管理器
     *
     * @return \Zangyd\Util\ZangydHttp\Handler\Swoole\HttpConnectionManager
     */ 
     ...
     * Get http2 连接管理器
     *
     * @return \Zangyd\Util\ZangydHttp\Handler\Swoole\Http2ConnectionManager
     */ 
