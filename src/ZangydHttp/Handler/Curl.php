...
use Zangyd\Util\ZangydHttp\FormDataBuilder;
...
class Curl implements IHandler
{
    ...
    public function __construct()
    {
        if(null === static::$defaultUA)
        {
            ...
            static::$defaultUA = sprintf('Mozilla/5.0 ZangydHttp/%s Curl/%s', ZangydHttp::VERSION, isset($version['version']) ? $version['version'] : 'unknown');
        }
     ...
     * @param \Zangyd\Util\ZangydHttp\Http\Request $request
     * @param resource $handler
     * @param \Zangyd\Util\ZangydHttp\Http\Psr7\Uri|null $uri
